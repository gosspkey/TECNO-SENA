...
class Proyectores {
    ...
    public function crearProyector() {
        if ($this->validarExistencia()) {
            echo "Error: El proyector con la placa {$this->placa} ya existe.";
            return false;
        }
    ...
    public function listarProyectores() {
    ...
    public function eliminarProyector($codigoEquipo) {
