...
<head>
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <link rel="stylesheet" href="../css/style.css"> 
    <title>Perfil administrador - TECNO-SENA</title>
    <style>
        footer { background-color: #5EA617; color: white; margin-bottom: 0 !important; }
        footer a, footer p, footer h2, footer strong { color: white !important; }
        html, body { margin: 0; padding: 0; height: 100%; }
...
<div class="container text-center mt-5 d-flex align-items-center justify-content-center">   
    ...
    <h1 class="titulo-perfil">Hola <?php echo htmlspecialchars($data['Nombread']) . " " . htmlspecialchars($data['Apellidoad']); ?>!</h1>
</div>

<div class="container text-center mt-3">
    <button class="btn btn-perfil" type="button" data-toggle="collapse" data-target="#infoadministrador" aria-expanded="false" aria-controls="infoadministrador">
        Aquí tu información
    </button>
    <div class="collapse mt-3 info-perfil" id="infoadministrador">
        <div class="colperfil text-center justify-content-center">
            ...
            <div class="col-eq justify-content-center">
                <?php
                echo "<p>Identificación: " . htmlspecialchars($data['Identificacionad']) . " " . htmlspecialchars($data['Documentoad']) . "</p>";
                echo "<p>Correo: " . htmlspecialchars($data['Emailad']) . "</p>";
...
<div class="container text-center mt-3">
    <a href='ajusteadministrador.php?id=<?php echo htmlspecialchars($_SESSION['Idad']); ?>' class='btn btn1'>Actualiza tus datos</a>
    <a href='actuacontraadm.php?id=<?php echo htmlspecialchars($_SESSION['Idad']); ?>' class='btn btn1'>Cambia tu contraseña</a>
    <br>
...
<?php
    ...
    echo "<div class='container text-center mt-5'><div class='alert alert-warning'>No se encontró información del administrador.</div></div>";
}
?>
   <footer class="mt-5 border-top">
