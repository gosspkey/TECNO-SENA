...
$portatil = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
...
<body>
    ...
    <form action="../../controlador/reservacont.php" method="POST" class="container">
        <h2 class="titulo text-center"><strong>Reserva de Portatil</strong></h2>
        <div class="row">
            <div class="col-md-6">
            <img src="../img/computadorPro.png" class="img-fluid-1 img-fluid" alt="">
            </div>
            ...
            value="<?php echo date('Y-m-d\TH:i'); ?>" readonly required>
                ...
                <label for="CodEquipo" class="mr-2">¿Qué portatil deseas reservar?</label>
                <select name="CodPortatil" id="CodPortatil" class="form-control" required>
                <option value="">Seleccione una opción</option>
                    <?php foreach ($portatil as $portatil): ?>
