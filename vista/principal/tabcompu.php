...
$portatil= new Portatil($db);
$portatil = $portatil->listarpor();

if (!$portatil || $portatil->rowCount()==0){
    echo "<br>";
    echo "<div class='alert alert-warning'>No hay equipos registrados </div>";
}else

{
        echo "<h1>Portatiles</h1>";
