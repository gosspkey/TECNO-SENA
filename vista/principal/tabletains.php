...
<body>
    ...
    <form action="../../controlador/reservacontins.php" method="POST" class="container">
        <h2 class="titulo text-center"><strong>Reserva de Tablet (Instructores)</strong></h2>
        <div class="row">
            <div class="col-md-6">
                <img src="../img/tablet651.png" class="img-fluid img-fluid-1" alt="Tablet Image" width="300px">
            </div>
            ...
            <input type="hidden" name="tipoEquipo" value="tableta">

            <label for="CodTableta" class="mr-2">¿Qué tableta deseas reservar?</label>
                <select name="CodTableta" id="CodTableta" class="form-control" required>
