...
$proyectores= new Proyectores($db);
$proyectores = $proyectores->listarProyectores();

if (!$proyectores || $proyectores->rowCount()==0){
    echo "<br>";
    echo "<div class='alert alert-warning'>No hay equipos registrados </div>";}else
{


        echo "<h1>Proyectores</h1>";
