...
$sonido= new Sonido($db);
$sonido = $sonido->listarSonido();

if (!$sonido || $sonido->rowCount()==0){
    echo "<br>";
    echo "<div class='alert alert-warning'>No hay equipos registrados </div>";}else
{


        echo "<h1>Equipos de Sonido</h1>";
